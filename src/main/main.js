...
const mainbod = document.createElement("div");
mainbod.classList.add("mainContent");
...
mainbod.appendChild(kitchenView);
...
mainbod.appendChild(imageSection);
